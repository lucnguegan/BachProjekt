...
<html>
    ...
    <body>
        ...
        <table id="table" style="width: 50%">
            <caption id="caption">Liste der Computer an der Röntgen-Abteilung</caption>
                <tr>
                    <th>ID</th>
                    <th>Abteilung</th>
                    <th>Hersteller</th>
        ...
        <?php
            ...
            $query = "SELECT * FROM Computers WHERE Abteilung ='Röntgen'";
            $stat = $db->query($query);
            $tab = $stat->fetchAll();
